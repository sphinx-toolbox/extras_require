...
description_block = """Display a warning at the top of module documentation that it has additional requirements.
...
source:
  url: "https://pypi.io/packages/source/e/extras_require/extras_require-{__version__}.tar.gz"
...
about:
  home: "https://github.com/domdfcoding/extras_require"
  license: "BSD License"
  # license_family: LGPL
  # license_file: LICENSE
  summary: "Display a warning at the top of module documentation that it has additional requirements."
  description: "{description_block}"
  doc_url: https://extras_require.readthedocs.io
  dev_url: https://github.com/domdfcoding/extras_require
